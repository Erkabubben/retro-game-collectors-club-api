...
router.put('/:console/:id', auth.authenticateJWT, ensureUserIsResourceOwner, (req, res, next) => controller.update(req, res, next))

router.patch('/:console/:id', auth.authenticateJWT, ensureUserIsResourceOwner, (req, res, next) => controller.partialUpdate(req, res, next))

router.delete('/:console/:id', auth.authenticateJWT, ensureUserIsResourceOwner, (req, res, next) => controller.delete(req, res, next))
